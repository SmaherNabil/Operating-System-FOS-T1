...
void fault_handler(struct Trapframe *tf)
{
	...
	else
	{
		if (userTrap)
		{
			...
			if (((perm&PERM_PRESENT)&&!(perm &PERM_USER))||((perm&PERM_PRESENT)&&!(perm&PERM_WRITEABLE))
					||(((perm&PERM_MARKED)==0)&&(fault_va >= USER_HEAP_START && fault_va < USER_HEAP_MAX)))
			{
...
//				sched_kill_env(curenv->env_id);
//			}
//			 if((fault_va >= USER_HEAP_START && fault_va < USER_HEAP_MAX)&&((perm&PERM_MARKED)==0)){
//
//					sched_kill_env(curenv->env_id);
//				 }
			/*============================================================================================*/
